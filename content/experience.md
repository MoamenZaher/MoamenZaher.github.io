...
sections:
  ...
  - block: resume-awards
    content:
      title: Courses
      text:       You can view all the certficiates on <a href="https://drive.google.com/drive/folders/1TP5jjlEKbFx8otQKbliXy1CUfm-TqAxh?usp=sharing" style="color:green;font-weight:bold;text-decoration:underline;}">Google Drive</a>
  ...
  - block: markdown
    content:
      text: |
        ## List of Trainings
        You can view all the certficiates on [Google Drive](https://drive.google.com/drive/folders/1TP5jjlEKbFx8otQKbliXy1CUfm-TqAxh?usp=sharing)
